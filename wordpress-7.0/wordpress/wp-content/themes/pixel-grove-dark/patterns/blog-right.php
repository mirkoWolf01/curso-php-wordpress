<?php
 /**
  * Title: Blog Right
  * Slug: pixel-grove-dark/blog-right
  * Inserter: no
  */
?>
...
<h1 class="wp-block-heading has-text-align-center" style="font-size:32px;font-style:normal;font-weight:700"><?php echo esc_html__( 'Blog Right Sidebar', 'pixel-grove-dark' ); ?></h1>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->
