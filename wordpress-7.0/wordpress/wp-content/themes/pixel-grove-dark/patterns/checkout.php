<?php
 /**
  * Title: Checkout
  * Slug: pixel-grove-dark/checkout
  * Inserter: no
  */
?>
...
<main class="wp-block-group" style="padding-right:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)"><!-- wp:woocommerce/checkout -->
